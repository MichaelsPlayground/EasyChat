...
public class Okhttp3ProgressDownloader {
    ...
    public Okhttp3ProgressDownloader(String downloadUrl, String storageFilename, LinearProgressIndicator progressIndicator) {
...
*/
            ...
            output.close();
            input.close();
            System.out.println("written total: " + total);
        }
