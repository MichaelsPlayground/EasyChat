...
public class StorageFileAdapter extends RecyclerView.Adapter<StorageFileAdapter.ViewHolder> {

    Context context;
    ArrayList<StorageFileModel> arrayList;
    OnItemClickListener onItemClickListener;

    public StorageFileAdapter(Context context, ArrayList<StorageFileModel> arrayList) {
